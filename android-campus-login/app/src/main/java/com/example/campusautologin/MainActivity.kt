...
class MainActivity : AppCompatActivity() {
    ...
    private fun connectWifiThenLogin(username: String, password: String) {
        ...
        val request = NetworkRequest.Builder()
            ...
            .build()
        connectivity.requestNetwork(request, object : ConnectivityManager.NetworkCallback() {
    ...
    override fun onDestroy() {
        requestedNetwork?.let { connectivity.unregisterNetworkCallback(object : ConnectivityManager.NetworkCallback() {}) }
        super.onDestroy()
    }
}
